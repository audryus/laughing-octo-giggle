...
func _ready() -> void:
	...
	_line_edit.text_submitted.connect(_on_search_nutton_pressed)
	_search_button.pressed.connect(_on_search_nutton_pressed)
...
func _on_search_nutton_pressed() -> void:
	var packet := packets.Packet.new()
